...
typedef enum WasmRelocType {
  WASM_RELOC_FUNC_INDEX = 0, /* LEB128. e.g. immediate of call instruction */
  WASM_RELOC_TABLE_INDEX = 1, /* SLEB128. e.g. loading address of function */
  WASM_RELOC_GLOBAL_INDEX = 2, /* LEB123. e.g immediate of get_global inst */
  WASM_RELOC_DATA = 3,
