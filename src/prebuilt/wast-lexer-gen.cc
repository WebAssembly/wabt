...
#line 4618 "src/prebuilt/wast-lexer-gen.cc"
yy742:
		yych = *++cursor_;
...
#line 5698 "src/prebuilt/wast-lexer-gen.cc"
yy970:
		yych = *++cursor_;
...
#line 6052 "src/prebuilt/wast-lexer-gen.cc"
yy1040:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 7106 "src/prebuilt/wast-lexer-gen.cc"
yy1283:
		yych = *++cursor_;
...
#line 7414 "src/prebuilt/wast-lexer-gen.cc"
yy1351:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 7513 "src/prebuilt/wast-lexer-gen.cc"
yy1370:
		yych = *++cursor_;
		if (yych == '/') goto yy1424;
		goto yy87;
...
#line 7745 "src/prebuilt/wast-lexer-gen.cc"
yy1419:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
yy1465:
		yych = *++cursor_;
		if (yych == '3') goto yy1510;
		goto yy87;
yy1466:
		yych = *++cursor_;
		if (yych == '3') goto yy1511;
		if (yych == '6') goto yy1512;
		goto yy87;
yy1467:
		yych = *++cursor_;
...
yy1476:
		yych = *++cursor_;
		if (yych == 'b') goto yy1524;
		goto yy87;
yy1477:
		yych = *++cursor_;
		if (yych == 'h') goto yy1526;
		goto yy87;
yy1478:
		yych = *++cursor_;
...
#line 8097 "src/prebuilt/wast-lexer-gen.cc"
yy1506:
		yych = *++cursor_;
		if (yych == '.') goto yy1552;
		goto yy87;
...
#line 8183 "src/prebuilt/wast-lexer-gen.cc"
yy1526:
		yych = *++cursor_;
...
#line 8459 "src/prebuilt/wast-lexer-gen.cc"
yy1588:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 8467 "src/prebuilt/wast-lexer-gen.cc"
yy1590:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 8609 "src/prebuilt/wast-lexer-gen.cc"
yy1624:
		yych = *++cursor_;
...
#line 8681 "src/prebuilt/wast-lexer-gen.cc"
yy1642:
		yych = *++cursor_;
		if (yych == 'x') goto yy1689;
		goto yy87;
yy1643:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
...
#line 8729 "src/prebuilt/wast-lexer-gen.cc"
yy1654:
		yych = *++cursor_;
...
#line 8905 "src/prebuilt/wast-lexer-gen.cc"
yy1698:
		yych = *++cursor_;
...
#line 8929 "src/prebuilt/wast-lexer-gen.cc"
yy1704:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 8945 "src/prebuilt/wast-lexer-gen.cc"
yy1708:
		yych = *++cursor_;
...
#line 9001 "src/prebuilt/wast-lexer-gen.cc"
yy1722:
		yych = *++cursor_;
		if (yych == 'h') goto yy1733;
		goto yy87;
yy1723:
		yych = *++cursor_;
...
#line 9017 "src/prebuilt/wast-lexer-gen.cc"
yy1726:
		yych = *++cursor_;
...
#line 9121 "src/prebuilt/wast-lexer-gen.cc"
yy1752:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
