...
#line 398 "src/prebuilt/wast-lexer-gen.cc"
yy14:
	yych = *++cursor_;
...
#line 323 "src/wast-lexer.cc"
	{ ERROR("bad escape \"%.*s\"",
                                  ...
                                  continue; }
#line 441 "src/prebuilt/wast-lexer-gen.cc"
yy22:
	yych = *++cursor_;
	if (yych <= '@') {
		if (yych <= '/') goto yy21;
...
#line 548 "src/prebuilt/wast-lexer-gen.cc"
yy42:
	yych = *++cursor_;
...
#line 550 "src/wast-lexer.cc"
		{ NEWLINE; continue; }
#line 688 "src/prebuilt/wast-lexer-gen.cc"
yy62:
		++cursor_;
yy63:
#line 566 "src/wast-lexer.cc"
		{ MAYBE_MALFORMED_UTF8(""); }
#line 694 "src/prebuilt/wast-lexer-gen.cc"
yy64:
		yych = *++cursor_;
...
#line 1030 "src/prebuilt/wast-lexer-gen.cc"
yy99:
		++cursor_;
...
#line 566 "src/wast-lexer.cc"
		{ MAYBE_MALFORMED_UTF8(""); }
#line 1202 "src/prebuilt/wast-lexer-gen.cc"
yy122:
		yych = *++cursor_;
...
#line 547 "src/wast-lexer.cc"
		{ SET_TEXT; RETURN(VAR); }
#line 1371 "src/prebuilt/wast-lexer-gen.cc"
yy143:
		++cursor_;
...
#line 1414 "src/prebuilt/wast-lexer-gen.cc"
yy147:
		++cursor_;
		if ((limit_ - cursor_) < 3) FILL(3);
		yych = *cursor_;
...
#line 1479 "src/prebuilt/wast-lexer-gen.cc"
yy154:
		yych = *++cursor_;
		if (yych <= ',') {
			if (yych == '+') goto yy207;
...
#line 549 "src/wast-lexer.cc"
		{ continue; }
#line 1502 "src/prebuilt/wast-lexer-gen.cc"
yy158:
		yych = *++cursor_;
...
#line 1989 "src/prebuilt/wast-lexer-gen.cc"
yy242:
		yych = *++cursor_;
...
#line 2001 "src/prebuilt/wast-lexer-gen.cc"
yy245:
		yych = *++cursor_;
...
#line 2051 "src/prebuilt/wast-lexer-gen.cc"
yy254:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 542 "src/wast-lexer.cc"
		{ RETURN(TRY); }
#line 2120 "src/prebuilt/wast-lexer-gen.cc"
yy271:
		yych = *++cursor_;
...
#line 345 "src/wast-lexer.cc"
		{ RETURN(CALL); }
#line 2260 "src/prebuilt/wast-lexer-gen.cc"
yy287:
		yych = *++cursor_;
...
#line 524 "src/wast-lexer.cc"
		{ RETURN(DATA); }
#line 2276 "src/prebuilt/wast-lexer-gen.cc"
yy291:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 341 "src/wast-lexer.cc"
		{ RETURN(LOOP); }
#line 2423 "src/prebuilt/wast-lexer-gen.cc"
yy313:
		yych = *++cursor_;
...
#line 511 "src/wast-lexer.cc"
		{ RETURN(TYPE); }
#line 2504 "src/prebuilt/wast-lexer-gen.cc"
yy333:
		yych = *++cursor_;
...
#line 337 "src/wast-lexer.cc"
		{ RETURN(BLOCK); }
#line 2561 "src/prebuilt/wast-lexer-gen.cc"
yy344:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 543 "src/wast-lexer.cc"
		{ RETURN_LPAR(CATCH); }
#line 2598 "src/prebuilt/wast-lexer-gen.cc"
yy350:
		yych = *++cursor_;
...
#line 3259 "src/prebuilt/wast-lexer-gen.cc"
yy489:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 3534 "src/prebuilt/wast-lexer-gen.cc"
yy547:
		yych = *++cursor_;
...
#line 3911 "src/prebuilt/wast-lexer-gen.cc"
yy626:
		yych = *++cursor_;
...
#line 3952 "src/prebuilt/wast-lexer-gen.cc"
yy636:
		yych = *++cursor_;
...
#line 4141 "src/prebuilt/wast-lexer-gen.cc"
yy682:
		yych = *++cursor_;
...
#line 6526 "src/prebuilt/wast-lexer-gen.cc"
yy1226:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
