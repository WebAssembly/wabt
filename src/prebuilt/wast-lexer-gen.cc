...
#line 313 "src/prebuilt/wast-lexer-gen.cc"
{
	unsigned char yych;
...
#line 363 "src/wast-lexer.cc"
	{ ERROR("illegal character in string");
                                  continue; }
#line 361 "src/prebuilt/wast-lexer-gen.cc"
yy5:
	++cursor_;
	BEGIN(YYCOND_i);
...
#line 434 "src/prebuilt/wast-lexer-gen.cc"
yy14:
	yych = *++cursor_;
...
#line 359 "src/wast-lexer.cc"
	{ ERROR("bad escape \"%.*s\"",
                                  ...
                                  continue; }
#line 477 "src/prebuilt/wast-lexer-gen.cc"
yy22:
	yych = *++cursor_;
	if (yych <= '@') {
		if (yych <= '/') goto yy21;
...
#line 593 "src/wast-lexer.cc"
	{ NEWLINE; continue; }
#line 570 "src/prebuilt/wast-lexer-gen.cc"
yy38:
	yych = *++cursor_;
	if (yych == ';') goto yy48;
	goto yy35;
...
#line 590 "src/wast-lexer.cc"
	{ if (--COMMENT_NESTING == 0)
                                    BEGIN(YYCOND_INIT);
                                  continue; }
#line 626 "src/prebuilt/wast-lexer-gen.cc"
yy52:
	yych = *++cursor_;
...
#line 586 "src/wast-lexer.cc"
		{ NEWLINE; continue; }
#line 724 "src/prebuilt/wast-lexer-gen.cc"
yy62:
		++cursor_;
yy63:
#line 602 "src/wast-lexer.cc"
		{ MAYBE_MALFORMED_UTF8(""); }
#line 730 "src/prebuilt/wast-lexer-gen.cc"
yy64:
		yych = *++cursor_;
...
#line 953 "src/prebuilt/wast-lexer-gen.cc"
yy81:
		++cursor_;
		if (limit_ <= cursor_) FILL(1);
		yych = *cursor_;
...
#line 345 "src/wast-lexer.cc"
		{ LOOKAHEAD(LPAR); }
#line 1016 "src/prebuilt/wast-lexer-gen.cc"
yy94:
		++cursor_;
...
#line 1066 "src/prebuilt/wast-lexer-gen.cc"
yy99:
		++cursor_;
...
#line 602 "src/wast-lexer.cc"
		{ MAYBE_MALFORMED_UTF8(""); }
#line 1238 "src/prebuilt/wast-lexer-gen.cc"
yy122:
		yych = *++cursor_;
...
#line 583 "src/wast-lexer.cc"
		{ SET_TEXT; RETURN(VAR); }
#line 1407 "src/prebuilt/wast-lexer-gen.cc"
yy143:
		++cursor_;
		BEGIN(YYCOND_BLOCK_COMMENT);
#line 588 "src/wast-lexer.cc"
		{ COMMENT_NESTING = 1; continue; }
#line 1413 "src/prebuilt/wast-lexer-gen.cc"
yy145:
		++cursor_;
		if ((yych = *cursor_) <= '9') {
			if (yych <= '\'') {
...
#line 1515 "src/prebuilt/wast-lexer-gen.cc"
yy154:
		yych = *++cursor_;
		if (yych <= ',') {
			if (yych == '+') goto yy207;
...
#line 1926 "src/prebuilt/wast-lexer-gen.cc"
yy231:
		++cursor_;
		if ((yych = *cursor_) <= ')') {
			if (yych <= '!') {
...
#line 567 "src/wast-lexer.cc"
		{ RETURN(GET); }
#line 1973 "src/prebuilt/wast-lexer-gen.cc"
yy236:
		yych = *++cursor_;
...
#line 578 "src/wast-lexer.cc"
		{ RETURN(TRY); }
#line 2156 "src/prebuilt/wast-lexer-gen.cc"
yy271:
		yych = *++cursor_;
...
#line 560 "src/wast-lexer.cc"
		{ RETURN(DATA); }
#line 2312 "src/prebuilt/wast-lexer-gen.cc"
yy291:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 383 "src/wast-lexer.cc"
		{ RETURN(DROP); }
#line 2320 "src/prebuilt/wast-lexer-gen.cc"
yy293:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 548 "src/wast-lexer.cc"
		{ RETURN(FUNC); }
#line 2387 "src/prebuilt/wast-lexer-gen.cc"
yy303:
		yych = *++cursor_;
...
#line 375 "src/wast-lexer.cc"
		{ RETURN(THEN); }
#line 2528 "src/prebuilt/wast-lexer-gen.cc"
yy330:
		yych = *++cursor_;
...
#line 547 "src/wast-lexer.cc"
		{ RETURN(TYPE); }
#line 2540 "src/prebuilt/wast-lexer-gen.cc"
yy333:
		yych = *++cursor_;
...
#line 2573 "src/prebuilt/wast-lexer-gen.cc"
yy338:
		yych = *++cursor_;
		if (yych == '=') goto yy438;
		goto yy87;
...
#line 373 "src/wast-lexer.cc"
		{ RETURN(BLOCK); }
#line 2597 "src/prebuilt/wast-lexer-gen.cc"
yy344:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 579 "src/wast-lexer.cc"
		{ RETURN_LPAR(CATCH); }
#line 2634 "src/prebuilt/wast-lexer-gen.cc"
yy350:
		yych = *++cursor_;
...
#line 556 "src/wast-lexer.cc"
		{ RETURN(TABLE); }
#line 3056 "src/prebuilt/wast-lexer-gen.cc"
yy434:
		yych = *++cursor_;
...
#line 554 "src/wast-lexer.cc"
		{ RETURN(BIN); }
#line 3094 "src/prebuilt/wast-lexer-gen.cc"
yy443:
		yych = *++cursor_;
...
#line 563 "src/wast-lexer.cc"
		{ RETURN(EXPORT); }
#line 3126 "src/prebuilt/wast-lexer-gen.cc"
yy451:
		yych = *++cursor_;
...
#line 3179 "src/prebuilt/wast-lexer-gen.cc"
yy464:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 3187 "src/prebuilt/wast-lexer-gen.cc"
yy466:
		yych = *++cursor_;
...
#line 3303 "src/prebuilt/wast-lexer-gen.cc"
yy491:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 3311 "src/prebuilt/wast-lexer-gen.cc"
yy493:
		yych = *++cursor_;
...
#line 3358 "src/prebuilt/wast-lexer-gen.cc"
yy501:
		yych = *++cursor_;
...
#line 3570 "src/prebuilt/wast-lexer-gen.cc"
yy547:
		yych = *++cursor_;
...
#line 543 "src/wast-lexer.cc"
		{ RETURN(SELECT); }
#line 3745 "src/prebuilt/wast-lexer-gen.cc"
yy585:
		yych = *++cursor_;
...
#line 3988 "src/prebuilt/wast-lexer-gen.cc"
yy636:
		yych = *++cursor_;
...
#line 4674 "src/prebuilt/wast-lexer-gen.cc"
yy794:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 576 "src/wast-lexer.cc"
		{ RETURN(ASSERT_TRAP); }
#line 5622 "src/prebuilt/wast-lexer-gen.cc"
yy998:
		yych = *++cursor_;
...
#line 6126 "src/prebuilt/wast-lexer-gen.cc"
yy1118:
		yych = *++cursor_;
