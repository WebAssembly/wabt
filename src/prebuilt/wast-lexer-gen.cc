...
#line 309 "src/wast-lexer.cc"
	{ ERROR("illegal character in string");
                                  continue; }
#line 307 "src/prebuilt/wast-lexer-gen.cc"
yy5:
	++cursor_;
	BEGIN(YYCOND_i);
#line 302 "src/wast-lexer.cc"
	{ ERROR("newline in string");
                                  NEWLINE;
                                  continue; }
#line 315 "src/prebuilt/wast-lexer-gen.cc"
yy7:
	++cursor_;
#line 301 "src/wast-lexer.cc"
	{ continue; }
#line 320 "src/prebuilt/wast-lexer-gen.cc"
yy9:
	++cursor_;
	BEGIN(YYCOND_i);
...
#line 305 "src/wast-lexer.cc"
	{ ERROR("bad escape \"%.*s\"",
                                  ...
                                  continue; }
#line 423 "src/prebuilt/wast-lexer-gen.cc"
yy22:
	yych = *++cursor_;
	if (yych <= '@') {
		if (yych <= '/') goto yy21;
...
#line 541 "src/wast-lexer.cc"
	{ continue; }
#line 511 "src/prebuilt/wast-lexer-gen.cc"
yy36:
	++cursor_;
...
#line 530 "src/prebuilt/wast-lexer-gen.cc"
yy42:
	yych = *++cursor_;
...
#line 565 "src/prebuilt/wast-lexer-gen.cc"
yy50:
	++cursor_;
...
#line 533 "src/wast-lexer.cc"
		{ NEWLINE; continue; }
#line 670 "src/prebuilt/wast-lexer-gen.cc"
yy62:
		++cursor_;
yy63:
#line 549 "src/wast-lexer.cc"
		{ MAYBE_MALFORMED_UTF8(""); }
#line 676 "src/prebuilt/wast-lexer-gen.cc"
yy64:
		yych = *++cursor_;
...
#line 899 "src/prebuilt/wast-lexer-gen.cc"
yy81:
		++cursor_;
		if (limit_ <= cursor_) FILL(1);
		yych = *cursor_;
...
#line 545 "src/wast-lexer.cc"
		{ ERROR("unexpected token \"%.*s\"",
                                        static_cast<int>(yyleng), yytext);
                                  continue; }
#line 928 "src/prebuilt/wast-lexer-gen.cc"
yy89:
		yyaccept = 0;
		yych = *(marker_ = ++cursor_);
...
#line 1012 "src/prebuilt/wast-lexer-gen.cc"
yy99:
		++cursor_;
...
#line 549 "src/wast-lexer.cc"
		{ MAYBE_MALFORMED_UTF8(""); }
#line 1184 "src/prebuilt/wast-lexer-gen.cc"
yy122:
		yych = *++cursor_;
...
#line 299 "src/wast-lexer.cc"
		{ TEXT; RETURN(TEXT); }
#line 1256 "src/prebuilt/wast-lexer-gen.cc"
yy133:
		++cursor_;
		if (limit_ <= cursor_) FILL(1);
		yych = *cursor_;
...
#line 1359 "src/prebuilt/wast-lexer-gen.cc"
yy145:
		++cursor_;
		if ((yych = *cursor_) <= '9') {
			if (yych <= '\'') {
...
#line 1396 "src/prebuilt/wast-lexer-gen.cc"
yy147:
		++cursor_;
		if ((limit_ - cursor_) < 3) FILL(3);
		yych = *cursor_;
...
#line 320 "src/wast-lexer.cc"
		{ RETURN(IF); }
#line 1596 "src/prebuilt/wast-lexer-gen.cc"
yy182:
		yych = *++cursor_;
...
#line 330 "src/wast-lexer.cc"
		{ RETURN(END); }
#line 1842 "src/prebuilt/wast-lexer-gen.cc"
yy227:
		yych = *++cursor_;
...
#line 524 "src/wast-lexer.cc"
		{ RETURN(TRY); }
#line 2102 "src/prebuilt/wast-lexer-gen.cc"
yy271:
		yych = *++cursor_;
...
#line 327 "src/wast-lexer.cc"
		{ RETURN(CALL); }
#line 2242 "src/prebuilt/wast-lexer-gen.cc"
yy287:
		yych = *++cursor_;
...
#line 323 "src/wast-lexer.cc"
		{ RETURN(LOOP); }
#line 2405 "src/prebuilt/wast-lexer-gen.cc"
yy313:
		yych = *++cursor_;
...
#line 525 "src/wast-lexer.cc"
		{ RETURN(CATCH); }
#line 2580 "src/prebuilt/wast-lexer-gen.cc"
yy350:
		yych = *++cursor_;
...
#line 510 "src/wast-lexer.cc"
		{ RETURN(EXCEPT); }
#line 3064 "src/prebuilt/wast-lexer-gen.cc"
yy449:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 4768 "src/prebuilt/wast-lexer-gen.cc"
yy826:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 5257 "src/prebuilt/wast-lexer-gen.cc"
yy932:
		++cursor_;
		if (yybm[0+(yych = *cursor_)] & 8) {
			goto yy86;
...
#line 5939 "src/prebuilt/wast-lexer-gen.cc"
yy1086:
		yych = *++cursor_;
