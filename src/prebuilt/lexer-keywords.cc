  ...
  static unsigned short asso_values[] =
    {
      ...
      2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631,
      2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631,
      2631, 2631, 2631, 2631, 2631, 2631,   14,   24, 2631,  118,
        11,   92,   10,  255,  138,  487,  537,  401,   22, 2631,
      2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631,
      2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631,
      2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631, 2631,
      2631, 2631, 2631, 2631, 2631,   10,   56,   30,   12,  132,
        31,   16,   10,  526,  714,   13,  240,   23,   35,   11,
...
#line 565 "src/lexer-keywords.txt"
      {"v128.load64_lane", TokenType::Load, Opcode::V128Load64Lane},
#line 564 "src/lexer-keywords.txt"
      {"v128.load32_lane", TokenType::Load, Opcode::V128Load32Lane},
      {""}, {""}, {""}, {""},
#line 562 "src/lexer-keywords.txt"
      {"v128.load8_lane", TokenType::Load, Opcode::V128Load8Lane},
      {""},
...
#line 568 "src/lexer-keywords.txt"
      {"v128.store32_lane", TokenType::Store, Opcode::V128Store32Lane},
      {""}, {""}, {""},
...
#line 563 "src/lexer-keywords.txt"
      {"v128.load16_lane", TokenType::Load, Opcode::V128Load16Lane},
...
#line 569 "src/lexer-keywords.txt"
      {"v128.store64_lane", TokenType::Store, Opcode::V128Store64Lane},
      {""},
...
#line 567 "src/lexer-keywords.txt"
      {"v128.store16_lane", TokenType::Store, Opcode::V128Store16Lane},
      {""}, {""}, {""},
...
#line 566 "src/lexer-keywords.txt"
      {"v128.store8_lane", TokenType::Store, Opcode::V128Store8Lane},
