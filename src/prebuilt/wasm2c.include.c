...
"  struct wasm2c_sandbox_t* const sbx = (struct wasm2c_sandbox_t* const) sbx_ptr;\n"
...
"  struct wasm2c_sandbox_t* const sbx = (struct wasm2c_sandbox_t* const) calloc(sizeof(struct wasm2c_sandbox_t), 1);\n"
"  if (!init_memory(sbx)) {\n"
"    free(sbx);\n"
"    return 0;\n"
"  }\n"
...
"  struct wasm2c_sandbox_t* const sbx = (struct wasm2c_sandbox_t* const) aSbx;\n"
"  cleanup_memory(sbx);\n"
