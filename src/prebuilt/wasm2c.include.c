...
"  static inline void WASM_RT_CC name(wasm_rt_memory_t* mem, u64 addr, t2 value) { \\\n"
"    MEMCHECK(mem, addr, t1);                                 \\\n"
"    t1 wrapped = (t1)value;                                  \\\n"
...
"#if _M_X64 || _M_IX86\n"
"  return _mm_cvtss_f32(_mm_or_ps(_mm_and_ps(_mm_set_ss(x), _mm_castsi128_ps(_mm_set_epi32(0, 0, 0, 0x7fffffffu))),\n"
"                                 _mm_and_ps(_mm_set_ss(y), _mm_castsi128_ps(_mm_set_epi32(0, 0, 0, 0x80000000u)))));\n"
"#else\n"
"#error unexpected architecture\n"
"#endif\n"
"}\n"
...
"#if _M_X64 || _M_IX86\n"
"  return _mm_cvtsd_f64(_mm_or_pd(_mm_and_pd(_mm_set_sd(x), _mm_castsi128_pd(_mm_set_epi32(0, 0, 0x7fffffffu, 0xffffffffu))),\n"
"                                 _mm_and_pd(_mm_set_sd(y), _mm_castsi128_pd(_mm_set_epi32(0, 0, 0x80000000u, 0)))));\n"
"#else\n"
"#error unexpected architecture\n"
"#endif\n"
"}\n"
