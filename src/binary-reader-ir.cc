...
class BinaryReaderIR : public BinaryReaderNop {
 public:
  ...
  Result OnSimdShuffle2ImmOpExpr(Opcode opcode, v128 value) override;
...
Result BinaryReaderIR::OnSimdShuffle2ImmOpExpr(Opcode opcode, v128 value) {
  return AppendExpr(MakeUnique<SimdShuffle2ImmOpExpr>(opcode, value));
}
