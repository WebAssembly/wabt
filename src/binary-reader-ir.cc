...
Result BinaryReaderIR::OnArrayGet(Opcode opcode, Index type_index) {
  return AppendExpr(
...
Result BinaryReaderIR::OnStructGet(Opcode opcode,
                                   Index type_index,
                                   Index field_index) {
...
Result BinaryReaderIR::OnStructNewDefault(Index type_index) {
  return AppendExpr(
