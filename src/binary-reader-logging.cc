...
Result BinaryReaderLogging::OnStructGet(Opcode opcode,
                                        Index type_index,
                                        Index field_index) {
  ...
  return reader_->OnStructGet(opcode, type_index, field_index);
}
...
DEFINE_OPCODE_INDEX(OnArrayGet, "type_index")
DEFINE_INDEX_DESC(OnArrayNew, "type_index")
DEFINE_INDEX_INDEX(OnArrayNewData, "type_index", "data_index")
DEFINE_INDEX_DESC(OnArrayNewDefault, "type_index")
DEFINE_INDEX_INDEX(OnArrayNewElem, "type_index", "elem_index")
DEFINE_INDEX_INDEX(OnArrayNewFixed, "type_index", "count")
DEFINE_INDEX_DESC(OnArraySet, "type_index")
...
DEFINE_INDEX_DESC(OnStructNew, "type_index")
DEFINE_INDEX_DESC(OnStructNewDefault, "type_index")
