...
static void rot13(void) {
  ...
  i0 = 0u;
  i1 = 1024u;
  i0 = (*Z_hostZ_fill_bufZ_iii)(i0, i1);
  l0 = i0;
  L1: 
    i0 = l1;
    i1 = l0;
    ...
    i0 = l1;
    i1 = l1;
    i1 = i32_load8_u(Z_hostZ_mem, (u64)(i1));
    i1 = f2(i1);
    i32_store8(Z_hostZ_mem, (u64)(i0), i1);
    i0 = l1;
    i1 = 1u;
    i0 += i1;
    l1 = i0;
...
/* export: 'rot13' */
void (*WASM_RT_ADD_PREFIX(Z_rot13Z_vv))(void);

static void init_exports(void) {
  /* export: 'rot13' */
  WASM_RT_ADD_PREFIX(Z_rot13Z_vv) = (&rot13);
}
