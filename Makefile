...
WASI_FLAG := -DCMAKE_C_COMPILER=${ROOT_DIR}/scripts/zig-cc -DWASI=1 -DCMAKE_CXX_COMPILER=${ROOT_DIR}/scripts/zig-c++ \
    -DBUILD_LIBWASM=OFF -DBUILD_TESTS=OFF -DCMAKE_CROSSCOMPILING=TRUE -DCMAKE_CXX_COMPILER_WORKS=1 -DCMAKE_C_COMPILER_WORKS=1
