...
This directory contains the build configuration for third-party dependencies used
by the WABT web demos (located in `docs/demo`).
...
The demo applications (`docs/demo/wasm2wat/index.html` and 
`docs/demo/wat2wasm/index.html`) expect to find a compiled bundle at 
