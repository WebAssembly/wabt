...
class TypeChecker {
 public:
  ...
  Result OnStructNew(Index, const TypeVector&);
  Result OnStructNewDefault(Index);
  Result OnStructGet(Index, Type);
  Result OnStructSet(Index, Type);
  Result OnArrayNew(Index, Type);
  Result OnArrayNewDefault(Index);
  Result OnArrayNewFixed(Index, Type, Index);
  Result OnArrayNewData(Index);
  Result OnArrayNewElem(Index);
