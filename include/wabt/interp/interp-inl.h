...
template <> inline bool HasType<s32>(ValueType type) { return type.code() == ValueType::I32; }
template <> inline bool HasType<u32>(ValueType type) { return type.code() == ValueType::I32; }
template <> inline bool HasType<s64>(ValueType type) { return type.code() == ValueType::I64; }
template <> inline bool HasType<u64>(ValueType type) { return type.code() == ValueType::I64; }
template <> inline bool HasType<f32>(ValueType type) { return type.code() == ValueType::F32; }
template <> inline bool HasType<f64>(ValueType type) { return type.code() == ValueType::F64; }
